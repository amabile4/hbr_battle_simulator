...
test('destruction preview fixture keeps action-before destruction rates and DP-aware deltas', () => {
  ...
  assert.ok(Math.abs(Number(yukiBreakdown.rateAfter) - 121.75) < 1e-9);
  assert.ok(Math.abs(Number(yukiBreakdown.appliedGainPercent) - 21.75) < 1e-9);
  ...
  assert.equal(yukiBreakdown.breakHitNumber, 8);
  assert.equal(yukiBreakdown.damageBreakHitNumber, 8);
  assert.equal(yukiBreakdown.destructionStartHitNumber, 8);
  assert.equal(yukiBreakdown.destructionHitCount, 2);
  ...
  assert.ok(Math.abs(Number(yukiBreakdown.appliedDestructionWeight) - 0.5) < 1e-9);
  ...
  assert.equal(yukiBreakdown.hitBreakdown?.[6]?.isBreakHit, false);
  assert.equal(yukiBreakdown.hitBreakdown?.[6]?.isDamageBreakHit, false);
  assert.ok(Math.abs(Number(yukiBreakdown.hitBreakdown?.[6]?.hpApplied) - 0) < 1e-6);
  assert.ok(Math.abs(Number(yukiBreakdown.hitBreakdown?.[6]?.destructionWeight) - 0) < 1e-9);
  assert.ok(Math.abs(Number(yukiBreakdown.hitBreakdown?.[6]?.destructionGainPercent) - 0) < 1e-9);
  assert.ok(Math.abs(Number(yukiBreakdown.hitBreakdown?.[6]?.destructionRateAfterPercent) - 100.00) < 1e-9);
  assert.ok(Math.abs(Number(yukiBreakdown.hitBreakdown?.[7]?.hpApplied) - 424202.327731) < 1e-1);
  assert.ok(Math.abs(Number(yukiBreakdown.hitBreakdown?.[7]?.destructionGainPercent) - 10.875) < 1e-9);
  assert.ok(Math.abs(Number(yukiBreakdown.hitBreakdown?.[7]?.destructionRateAfterPercent) - 110.875) < 1e-9);
  assert.ok(Math.abs(Number(yukiBreakdown.hitBreakdown?.[8]?.hpApplied) - 487147.285714) < 1e-1);
  assert.ok(Math.abs(Number(yukiBreakdown.hitBreakdown?.[8]?.destructionGainPercent) - 10.875) < 1e-9);
  assert.ok(Math.abs(Number(yukiBreakdown.hitBreakdown?.[8]?.destructionRateBeforePercent) - 110.875) < 1e-9);

  assert.ok(Math.abs(Number(miyaBreakdown.rateBefore) - 121.75) < 1e-9);
  assert.ok(Math.abs(Number(miyaBreakdown.rateAfter) - 706.46) < 1e-9);

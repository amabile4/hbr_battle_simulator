...
def main():
    ...
    SKIP_LIST = ["脆弱", "心眼", "やる気", "EXスキル連続発動", "ハッキング", "ジェネライズ", "霊符", "禍", "ハイブースト", "単独発動", "サポート枠", "共鳴アビリティ", "速弾き", "軽快", "SPが0以上であれば使用可能", "ターゲット集中", "Eシールド", "属性ブレスレット", "超ダウン状態", "蝕", "アトミックフレアと1MORE", "超越ゲージ", "総攻撃", "スキル攻撃ダメージ計算式"]

...
3. **ステータスボーナス処理**: PartySetup のメイン手入力値は、サポート補正を含む最終ステータスとして最優先する。メイン未入力時に限り、テンプレート①（Lv200・転生5回・能力ボード最大・装備なし）のメイン自動値へ、サポート枠の各自動値または手入力値の **10%を能力ごとに切り上げて**加算する。サポート自動値にも選択したサポートスタイルの限界突破数を反映する。装備・称号・ダフネ・期間/stage補正・条件付き能力上昇は含めない。
...
- [公式サポート枠仕様](https://wfs-heaven-burns-red.zendesk.com/hc/ja/articles/48890914006553-%E3%82%B5%E3%83%9D%E3%83%BC%E3%83%88%E6%9E%A0)
- [能力値計算・端数処理の検証](https://note.com/harumigg/n/nc897f0cac640)

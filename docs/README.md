...
| [active/lightweight_record_replay_implementation_tasklist.md](active/lightweight_record_replay_implementation_tasklist.md) | 🟢 進行中 | T01-T04 完了。`ReplayScript` schema / dual-write capture / best-effort replay executor を実装し、次は record derived output 化 | 2026-03-14 |

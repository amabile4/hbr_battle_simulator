...
| [active/t34_followup_tasklist.md](active/t34_followup_tasklist.md) | 🟢 進行中 | T34 フォローアップ。表示 unit / lifecycle integration は完了扱いへ整理し、残りを WBS-3e（enemy 関連メニュー統合）、browser E2E 残件、T34-FU1（per-source instance 管理）に絞り込み。2026-04-11 に単独 EX ターンでの非EX後衛追撃 attach 漏れを修正 | 2026-04-11 |

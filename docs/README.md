...
| [active/lightweight_record_replay_implementation_tasklist.md](active/lightweight_record_replay_implementation_tasklist.md) | 🟢 進行中 | T01-T08 完了。`ReplayScript` schema / replay / derived record / slot-operation-note editor / extensible setup / legacy turnPlan bridge を実装し、次は warning / diagnostics | 2026-03-15 |

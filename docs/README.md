...
| [active/t34_enemy_status_management_plan_wbs.md](active/t34_enemy_status_management_plan_wbs.md) | 🟢 進行中 | T34（敵状態変化管理・表示）専用の実装プラン/WBS。段階1（break/follow-up類似の敵選択popup）→段階2（enemy関連メニュー統合）を含む実行順、リスク、AIレビュー観点、レビュー依頼テンプレートを定義 | 2026-04-05 |

...
| [active/t34_followup_tasklist.md](active/t34_followup_tasklist.md) | 🟢 進行中 | T34 フォローアップ。WBS-3e / E2E 残件 / T34-FU1 に加え、T34-FU4（statusType ソート順統一 — 暫定 v1 実装済み、SORT-TODO-1〜3 を v2 scope へ）を追加 | 2026-04-12 |

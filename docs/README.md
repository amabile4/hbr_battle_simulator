...
| [active/cond_refactor_wbs.md](active/cond_refactor_wbs.md) | 🟢 進行中 | cond/overwrite_cond AST評価器移植 WBS。Phase 0〜1完了。評価コアを `src/engine/` へ配備し、IsTalisman補完と対象55件・既存1296件の回帰確認済み。Phase 2〜7の担当・依存関係・受け入れ基準、enemy member生成・specialStatuses Map変換等のギャップ分析も収録 | 2026-06-27 |

...
| [calc/destruction_calculation_model.md](calc/destruction_calculation_model.md) | 📚 参照 | 破壊率計算モデル。通常攻撃式は実機実測に合わせて `raw d_rate/100`、超越ゲージ100%時のみ×1.10として `calculateDestruction` に統一済み | 2026-06-14 |

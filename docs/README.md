...
| [active/implementation_priority_tasklist.md](active/implementation_priority_tasklist.md) | 🟢 進行中 | 実装優先順位 PRI-017（PRI-016 完了。次優先は player-side enemy inflicted status manual hook / `T14`） | 2026-03-14 |

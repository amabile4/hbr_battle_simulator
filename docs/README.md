...
| [active/implementation_priority_tasklist.md](active/implementation_priority_tasklist.md) | 🟢 進行中 | 実装優先順位 PRI-010〜012（PRI-010 完了。次は敵状態異常基盤 / top-level `effect`） | 2026-03-14 |

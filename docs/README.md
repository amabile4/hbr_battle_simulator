...
| [active/implementation_priority_tasklist.md](active/implementation_priority_tasklist.md) | 🟢 進行中 | 実装優先順位 PRI-013〜015（PRI-013: active buff status、PRI-014: 条件式/レポート同期、PRI-015: 残り enemy status） | 2026-03-14 |
| [active/active_buff_status_implementation_tasklist.md](active/active_buff_status_implementation_tasklist.md) | 🟢 進行中 | PRI-013: active skill 由来 `AttackUp` / `DefenseUp` / `CriticalRateUp` / `CriticalDamageUp` の持続 status 基盤 | 2026-03-14 |

...
| [active/disaster_status_wbs.md](active/disaster_status_wbs.md) | 🟢 進行中 | 追加 JSON 再照合で見つかった `Disaster / 禍` の実装 WBS。画像仕様整理、`もつれトラップ` の enemy debuff state、`damageContext` 集約、enemy popup / field chip / char detail 表示、audit baseline 更新を管理 | 2026-04-10 |

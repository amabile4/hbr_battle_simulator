...
| [active/lightweight_record_replay_implementation_tasklist.md](active/lightweight_record_replay_implementation_tasklist.md) | 🟢 進行中 | T01-T03 完了。`ReplayScript` schema / typed envelope / dual-write capture を実装し、次は best-effort replay executor | 2026-03-14 |

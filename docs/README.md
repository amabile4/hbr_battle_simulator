...
| [active/damage_breakdown/unimplemented_elements_wbs.md](active/damage_breakdown/unimplemented_elements_wbs.md) | 🟢 進行中 | 威力詳細 v1 に掲載されていないがダメージ計算に関与する要素の洗い出し。A=追加実装対象 / B=将来対応 / C=意図的スコープ外 / D=要協議 で分類し、Priority 1〜3 で実装順を整理 | 2026-05-31 |

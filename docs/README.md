...
| [active/implementation_priority_tasklist.md](active/implementation_priority_tasklist.md) | 🟢 進行中 | 実装優先順位 PRI-010〜012（PRI-010/011 完了、PRI-012 は effect 監査初回波で `9 keys / 129 occurrences` まで圧縮） | 2026-03-14 |
...
| [active/top_level_effect_implementation_tasklist.md](active/top_level_effect_implementation_tasklist.md) | 🟢 進行中 | PRI-012: metadata-only 7 label を除外し、残件を active buff 系中心の 9 label へ整理 | 2026-03-14 |

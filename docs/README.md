...
| [active/implementation_priority_tasklist.md](active/implementation_priority_tasklist.md) | 🟢 進行中 | 実装優先順位 PRI-010〜012（PRI-010/011 完了。次は top-level `effect` 監査の PRI-012） | 2026-03-14 |

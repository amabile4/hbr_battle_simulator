...
| [active/e_shield_preparation_plan.md](active/e_shield_preparation_plan.md) | 🟢 進行中 | Eシールドの仕様調査と導入準備。外部仕様 / `json/enemies.json.extra_gauge.eshield` / `IgnoreEShieldElement` などのローカルデータを突き合わせ、Phase 0 の metadata plumbing と次フェーズの runtime 方針を整理 | 2026-04-18 |

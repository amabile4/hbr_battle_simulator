...
| [calc/destruction_calculation_model.md](calc/destruction_calculation_model.md) | 📚 参照 | 破壊率計算モデル。通常攻撃式は実機実測に合わせて `raw d_rate/100`、スキル式は Issue #19 の `(d_rate/8) × baseHit × dr × 加算ボーナス × Funnel倍率` に統一済み | 2026-06-14 |

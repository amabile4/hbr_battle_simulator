...
| ドキュメント | ステータス | 概要 | 最終更新 |
|-------------|-----------|------|----------|
| [calc/porting_design_guideline.md](calc/porting_design_guideline.md) | 🟢 進行中 | Python版コアロジックのTypeScript移植に伴う設計・命名統一ガイドライン | 2026-06-02 |
...
| [calc/phase3_wbs.md](calc/phase3_wbs.md) | 🟢 進行中 | フェーズ3 実装 WBS。T3.2.1〜T3.2.4 の初期 TypeScript 移植と T3.3.1 固定 fixture node:test を実装済み。`npm test` 1235件 PASS、Python 固定 fixture 6/6 PASS を確認。残りは大規模クロス言語アサーションテストと category fallback warning 方針確定 | 2026-06-02 |

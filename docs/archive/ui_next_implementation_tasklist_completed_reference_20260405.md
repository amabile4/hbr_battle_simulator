...
## 未完了 38 項目（優先順チェックリスト / 2026-04-05）

> 優先順: T16-B → T19 → T20-D/T20-E → T32（Phase2/3）→ T33 → T34
...
### 3) T20-D/T20-E: モバイル UI/タッチ UX（10項目）
...
### 4) T32: Stage Setup Phase2/3（2項目）
